...
1. **Main plugin class file:**
   ```
   src/SyliusEasyCrudPlugin.php → src/{CompanyName}{PluginName}.php
   ```
...
- Twig namespace references from `@SyliusEasyCrudPlugin` to `@{CompanyName}{PluginName}`
...
| Find | Replace |
|------|---------|
| `Adeliom` | `{CompanyName}\{PluginName}` |
| `SyliusEasyCrudPlugin` | `{CompanyName}{PluginName}` |
| `AcmeSyliusExampleExtension` | `{CompanyName}{PluginName}Extension` |
| `@SyliusEasyCrudPlugin` | `@{CompanyName}{PluginName}` |
| `Tests\Adeliom` | `Tests\{CompanyName}\{PluginName}` |
...
- `Adeliom\SyliusEasyCrudPlugin`
- `@SyliusEasyCrudPlugin/templates/...`
