...
class TextEditorField {
  ...
  #handleFormSubmission() {
    const entityForm = document.querySelector('.admin-layout__content form');
    entityForm.addEventListener('submit', (formEvent) => {
  ...
  #markInvalidFormFields() {
    ['.admin-layout__content form'].forEach((formSelector) => {
