...
final class MakeEasyCrud extends AbstractMaker
{
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator): void
    {
        ...
        $crud = $generator->createClassNameDetails($entity->getShortName(), $namespace, 'Admin');
        ...
        $generator->generateClass(
            $crud->getFullName(),
            __DIR__ . '/../Resources/skeleton/Admin.tpl.php',
            [
                'entity' => $entity,
