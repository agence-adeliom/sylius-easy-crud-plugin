...
final class CodeEditorField implements FieldInterface
{
    ...
    public static function new(string $propertyName, $label = null): self
    {
        return (new self())
            ...
            ->setLabel($label)
            ->addFormThemes(CodeEditorType::configureAdminFormThemes())
            ->setShowTemplatePath('@SyliusEasyCrudPlugin/field/codeeditor/show.html.twig')
            ->setGridTemplatePath('@SyliusEasyCrudPlugin/field/codeeditor/grid.html.twig')
            ->setFormType(CodeEditorType::class)
            ->addCssClass('field-code_editor')
            ->addAssets(CodeEditorType::configureAdminAssets())
            ...
            ->setCustomOption(self::OPTION_NUM_OF_ROWS, 6)
