...
final class DateTimeField implements FieldInterface
{
    ...
    public static function new(string $propertyName, $label = null): self
    {
        return (new self())
            ...
            ->setGridTemplatePath('@SyliusEasyCrudPlugin/field/datetime/grid.html.twig')
            ->setShowTemplatePath('@SyliusEasyCrudPlugin/field/datetime/show.html.twig')
    ...
    public function isImmutable(): self
    {
        $this->setCustomOption(self::IMMUTABLE, true);
