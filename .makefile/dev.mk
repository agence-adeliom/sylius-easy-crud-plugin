...
test.all: test.composer test.phpstan test.phpmd test.phpunit test.phpspec test.ecs test.yaml test.schema test.twig test.container ## Run all tests in once
...
HELP += $(call help,test.ecs,			Run PHP ECS in dry-run)
test.ecs:
	vendor/bin/ecs check src

HELP += $(call help,test.ecs.fix,		Run PHP ECS and fix issues if possible)
test.ecs.fix:
