...
### Core Structure
- **Main Plugin Class**: `src/SyliusEasyCrudPlugin.php` - Entry point using `SyliusPluginTrait`
- **DI Extension**: `src/DependencyInjection/SyliusEasyCrudExtension.php` - Handles service loading and Doctrine migrations
